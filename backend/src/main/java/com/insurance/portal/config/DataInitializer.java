    ...
    private void seedPackages() {
        ...
        List<InsurancePackage> packages = List.of(
            ...
            InsurancePackage.builder()
                ...
                .durationTiersJson("[{\"years\":1,\"premiumRate\":2.00},{\"years\":2,\"premiumRate\":1.90},{\"years\":3,\"premiumRate\":1.85},{\"years\":5,\"premiumRate\":1.75}]")
            ...
            InsurancePackage.builder()
                ...
                .durationTiersJson("[{\"years\":5,\"premiumRate\":2.50},{\"years\":10,\"premiumRate\":2.40},{\"years\":15,\"premiumRate\":2.30},{\"years\":20,\"premiumRate\":2.20}]")
            ...
            InsurancePackage.builder()
                ...
                .durationTiersJson("[{\"years\":1,\"premiumRate\":2.80},{\"years\":2,\"premiumRate\":2.65},{\"years\":3,\"premiumRate\":2.50}]")
            ...
            InsurancePackage.builder()
                ...
                .durationTiersJson("[{\"years\":1,\"premiumRate\":3.00},{\"years\":2,\"premiumRate\":2.85},{\"years\":3,\"premiumRate\":2.70}]")
                .paymentFrequency("YEARLY")
                .paymentIntervalMonths(12)
            ...
            InsurancePackage.builder()
                ...
                .durationTiersJson("[{\"years\":1,\"premiumRate\":1.50},{\"years\":2,\"premiumRate\":1.42},{\"years\":3,\"premiumRate\":1.35},{\"years\":5,\"premiumRate\":1.25}]")
                .paymentFrequency("YEARLY")
                .paymentIntervalMonths(12)
            ...
            InsurancePackage.builder()
                ...
                .durationTiersJson("[{\"years\":1,\"premiumRate\":1.80},{\"years\":2,\"premiumRate\":1.70},{\"years\":3,\"premiumRate\":1.60}]")
