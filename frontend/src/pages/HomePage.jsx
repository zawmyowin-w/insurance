...
const insuranceTypes = [
  { icon: '❤️', bg: '#fff0f0', color: '#dc2626', key: 'life' },
  { icon: '🏥', bg: '#f0fdf4', color: '#16a34a', key: 'health' },
  { icon: '🚗', bg: '#eff6ff', color: '#1d4ed8', key: 'vehicle' },
  { icon: '🏠', bg: '#fefce8', color: '#ca8a04', key: 'property' },
]
...
export default function HomePage() {
  ...
  const stats = [
    { value: '1M+', labelKey: 'home.stat1' },
    { value: '50+', labelKey: 'home.stat2' },
    { value: '99%', labelKey: 'home.stat3' },
    { value: '24/7', labelKey: 'home.stat4' },
  ]

  const steps = [
    { num: 1, icon: 'bi-search',          titleKey: 'home.step1Title', descKey: 'home.step1Desc' },
    { num: 2, icon: 'bi-file-earmark-text', titleKey: 'home.step2Title', descKey: 'home.step2Desc' },
    { num: 3, icon: 'bi-check-circle',    titleKey: 'home.step3Title', descKey: 'home.step3Desc' },
    { num: 4, icon: 'bi-shield-check',    titleKey: 'home.step4Title', descKey: 'home.step4Desc' },
  ]
    ...
    <div>
      ...
      <section className="hero-section">
        <svg className="hero-shield-bg" viewBox="0 0 200 220" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M100 5L15 38V105C15 153 52 195 100 210C148 195 185 153 185 105V38L100 5Z" fill="var(--primary)" />
            ...
            {stats.map(stat => (
              <div key={stat.labelKey} className="col-6 col-md-3">
                <div className="stat-card">
                  ...
                  <div className="stat-label" style={{ color: 'rgba(255,255,255,0.75)' }}>{t(stat.labelKey)}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-12 col-lg-6">
              ...
              {[
                { icon: 'bi-shield-check',    titleKey: 'home.why1Title', descKey: 'home.why1Desc' },
                { icon: 'bi-lightning-charge', titleKey: 'home.why2Title', descKey: 'home.why2Desc' },
                { icon: 'bi-people',           titleKey: 'home.why3Title', descKey: 'home.why3Desc' },
                { icon: 'bi-graph-up-arrow',   titleKey: 'home.why4Title', descKey: 'home.why4Desc' },
              ].map(item => (
                <div key={item.titleKey} className="d-flex gap-3 mb-3">
                  <div style={{
                  ...
                  <div>
                    <div style={{ fontWeight: 600, fontSize: '0.95rem', color: 'var(--text-primary)' }}>{t(item.titleKey)}</div>
                    <div style={{ color: 'var(--text-secondary)', fontSize: '0.88rem' }}>{t(item.descKey)}</div>
                  </div>
                </div>
              ))}
            </div>
              ...
              <div style={{
                ...
                <div className="d-flex flex-column gap-2">
                  <Link to="/register" style={{
                    ...
                    borderRadius: 8, fontWeight: 600, textDecoration: 'none', textAlign: 'center', fontSize: '0.95rem',
                  }}>
                    {t('home.ctaBoxBtn1')}
                  </Link>
                  <Link to="/plans" style={{
